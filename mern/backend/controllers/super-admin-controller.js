...
const superadminRegister = async (req, res) => {
    try {
        ...
        const existingSuperAdminByEmail = await SuperAdmin.findOne({ email: req.body.email });
        ...
        if (existingSuperAdminByEmail) {
            ...
            let result = await superadmin.save();
            result.password = undefined;
            res.send(result);
        }
    } catch (err) {
...
module.exports = { superadminRegister, superadminLogIn, getSuperAdminDetail };
